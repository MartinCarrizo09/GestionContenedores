...
- **Status obtenido**: 400
- **Resultado**: FAIL
- **Error**: El peso del contenedor es obligatorio, El volumen del contenedor es obligatorio, El código de identificación del contenedor es obligatorio
...
- **Status obtenido**: 400
- **Resultado**: FAIL
- **Error**: El volumen del contenedor es obligatorio, El código de identificación del contenedor es obligatorio, El peso del contenedor es obligatorio
...
- **Status obtenido**: 400
- **Resultado**: OK
- **Error**: El volumen del contenedor es obligatorio, El código de identificación del contenedor es obligatorio, El email del cliente debe ser válido, El peso del contenedor es obligatorio
